...
`;
  const placemark = new ymaps.Placemark([55.944122, 37.769460], {
    balloonContent: "Информация о клинике" // Здесь может быть произвольный HTML-код
  }, {
    iconLayout: ymaps.templateLayoutFactory.createClass(`<div class="map_logo" style="display: flex; align-items: center; justify-content: center;">` + `<img src="data:image/svg+xml;charset=utf-8,${encodeURIComponent(mainSvgIcon)}" width="36" height="36" />` + `</div>`),
...
const priceObject = {
  'терапевтическая стоматология': ["<span class='name'>Лечение кариеса от</span> <span>5000 руб</span> ", "<span class='name'>Лечение пульпита от</span> <span>6500 руб</span> ", "<span class='name'>Анестезия</span> <span>800 руб</span> "],
  'хирургическая стоматология': ["<span class='name'>Удаление зуба простое от</span> <span>4000 руб</span>", "<span class='name'>Удаление зуба сложное от</span> <span>5700 руб</span>", "<span class='name'>Анестезия</span> <span>800 руб</span>"],
  'профессиональная гигиена': ["<span class='name'>Профессиональная гигиена полости рта</span> <span>6000 руб</span> "],
  'детская стоматология': ['<span class="name">Лечение кариеса от</span> <span>4500 руб</span>', '<span class="name">Лечение пульпита от</span> <span>5500 руб</span>', '<span class="name">Удаление зуба от</span> <span>2500 руб</span>', '<span class="name">Анестезия</span> <span>800 руб</span>'],
  'ортопедическая стоматология': ['<span class="name">Коронка металлокерамическая от</span> <span>10000 руб</span>', '<span class="name">Вкладка культевая от</span> <span>7000 руб</span>', '<span class="name">Винир керамический от</span> <span>20000 руб</span>', '<span class="name">Частичный съемный протез от</span> <span>22500 руб</span>', '<span class="name">Полный съемный протез от</span> <span>25500 руб</span>', '<span class="name">Коронка на оксиде циркония от</span> <span>20000 руб</span>', '<span class="name">Коронка на имплантате керамическая от</span> <span>28500 руб</span>', '<span class="name">Коронка на имплантате циркониевая от</span> <span>30000 руб</span>', '<span class="name">Установка имплантата от</span> <span>35000 руб</span>']
};
...
/* harmony import */ var _components_popup__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_popup__WEBPACK_IMPORTED_MODULE_6__);
